    ...
    return Padding(
      ...
      child: Center(
          child: Column(
            ...
            for (int i = 0; i < _todayCnt; i++)
              TransactionItemView(dayIndex: 0, itemIndex: i, items: this._itemsToday),
            Padding(
              padding: const EdgeInsets.only(top: 10),
              child: Text('Yesterday', style: dayTitleStyle),
            ),
            for (int i = 0; i < _yestadayCnt; i++)
              TransactionItemView(dayIndex: 1, itemIndex: i, items: this._itemsYesteday),
          ])),
    );
  }
}
